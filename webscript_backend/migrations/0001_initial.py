...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Script'
        db.create_table('webscript_backend_script', (
        ...
        db.send_create_signal('webscript_backend', ['Script'])

        # Adding model 'Event'
        db.create_table('webscript_backend_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('webscript_backend', ['Event'])

        # Adding model 'Parameter'
        db.create_table('webscript_backend_parameter', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('webscript_backend', ['Parameter'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('webscript_backend_script')

        # Deleting model 'Event'
        db.delete_table('webscript_backend_event')

        # Deleting model 'Parameter'
        db.delete_table('webscript_backend_parameter')
